...
function FileUpload({ id }) {
  ...
  return (
    <div className="position-relative mx-auto" style={bg} id="file-upload">
      ...
      >
        <div className="row d-flex justify-content-center">
          <div className={`col-6 ${files.length === 0 ? "text-center" : ""}`}>
            <div className="big-text fw-bold">Tải tài liệu</div>
            <div className="text my-2">Tải tài liệu bạn muốn in</div>
          </div>
        ...
        >
          ...
          >
            <div className="text-2 fw-bold">Tài liệu đã tải</div>
