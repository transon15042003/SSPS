...
export default function Printer(props) {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.REACT_APP_SERVER_URL}/printer/getInfoPrinter/${props.id}`
      )
      .then((response) => {
  ...
  const handleUpdate = () => {
    ...
    const hasEmptyValue = Object.values(editPrinterData).some(
      (value) => value === ""
    );
    if (hasEmptyValue) {
      handleAlert();
      ...
      axios
        .put(
          `${process.env.REACT_APP_SERVER_URL}/printer/edit/${props.id}`,
          editPrinterData
        )
        .then((response) => {
  ...
  const handleViewInfoPrinter = () => {
    ...
    document.getElementById(`description${props.id}`).value =
      printer.description;
  ...
  const handleAfterUpdate = () => {
    ...
    document.getElementById(`name${props.id}`).defaultValue =
      document.getElementById(`name${props.id}`).value;
    document.getElementById(`brand${props.id}`).defaultValue =
      document.getElementById(`brand${props.id}`).value;
    document.getElementById(`model${props.id}`).defaultValue =
      document.getElementById(`model${props.id}`).value;
    document.getElementById(`description${props.id}`).defaultValue =
      document.getElementById(`description${props.id}`).value;
    document.getElementById(`campus${props.id}`).defaultValue =
      document.getElementById(`campus${props.id}`).value;
    document.getElementById(`building${props.id}`).defaultValue =
      document.getElementById(`building${props.id}`).value;
    document.getElementById(`room${props.id}`).defaultValue =
      document.getElementById(`room${props.id}`).value;
    document.getElementById(`status${props.id}`).defaultValue =
      document.getElementById(`status${props.id}`).value;
  };
        ...
        <Modal.Body>
          <div className="container-fluid">
            <div className="row mt-1 mb-1">
              <div className="col-4 mt-2">Tên máy in:</div>
              <div className="col">
                <input
            ...
            <div className="row mt-1 mb-1">
              <div className="col-4 mt-2">Hãng sản xuất:</div>
              <div className="col">
                <input
                  className="form-control"
                  type="text"
            ...
            <div className="row mt-1 mb-1">
              <div className="col-4 mt-2">Loại máy in:</div>
              <div className="col">
                <input
                  className="form-control"
                  type="text"
            ...
            <div className="row mt-1 mb-1">
              <div className="col-4 mt-2">Mô tả:</div>
              <div className="col">
                <textarea
                  className="form-control"
                  type="text"
            ...
            <div className="row mt-1 mb-1">
              <div className="col-2 mt-2">Vị trí:</div>
              <div className="col mt-2">
                <div>
                  ...
                  <select
                    ...
                    className="form-control"
                    disabled={isDisabled}
                    defaultValue={printer.loc_campus}
                  >
              ...
              <div className="col mt-2">
                ...
                <input
                  className="form-control"
                  type="text"
                  defaultValue={printer.loc_building}
                  id={"building" + props.id}
                  disabled={isDisabled}
                />
              </div>
              <div className="col mt-2">
            ...
            <div className="row mt-1 mb-1">
              <div className="col-4 mt-2">Trạng thái:</div>
              <div className="col">
                <select
                  name="status"
                  id={"status" + props.id}
          ...
          <div
            className={`alert alert-danger ${alertState ? "" : "d-none"}`}
            role="alert"
          >
