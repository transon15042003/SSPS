...
const docs = [{ uri: require("../assets/docs/CTDT.pdf") }];
...
function PrintConfig() {
    ...
    }, [cookies, navigate, removeCookie, token, state]);
    ...
    const handleSubmission = () => {
        const configData = {
            ...
            pages_per_sheet: document.getElementById("pages_per_sheet-select")
                .value,
        ...
        const hasEmptyValue = Object.values(configData).some(
            (value) => value === ""
        );
                ...
                <div className="row p-3">
                    ...
                    <div className="col-12 col-md-6 border-start border-secondary-subtle">
                        <ConfigArea
                            ...
                            support_function={handleSubmission}
                        />
                    </div>
                </div>
            </div>
